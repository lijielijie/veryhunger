...
public class LoginInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		/*
		 * HttpSession s=request.getSession(); User u=(User)
		 * s.getAttribute(BaseSet.USER); if (null==u||!(boolean)
		 * s.getAttribute(BaseSet.LOGIN_FLAG)) { response.sendRedirect("/user/login");
		 * return false; }
		 */
		return true;
	}
